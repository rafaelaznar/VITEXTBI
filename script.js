        ...
        testFC.prob.push(
          {
            "number": i,
            "name": f1[i].name,
            "prob": getProbW(testFC.textContent, f1[i].fTable, 1, fword1, fword2)
          });
      }
      if (f1[i].fTable[0][0] == "W21") {
        var fword1 = function (str, i) { return str[i].toLowerCase() + " " + str[i + 1].toLowerCase() };
        var fword2 = function (str, i) { return str[i + 2].toLowerCase() };
        testFC.prob.push(
          {
